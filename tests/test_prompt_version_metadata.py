...
class TestEvaluateSingleWithPromptMetadata:
    ...
    def test_evaluate_single_integration_with_metadata(self, cli_runner, tmp_path, monkeypatch):
        ...
        with (
            patch("prompt_evaluator.cli.get_provider") as mock_get_provider,
    ...
    def test_evaluate_single_integration_without_version(self, cli_runner, tmp_path, monkeypatch):
...
class TestEvaluateDatasetWithPromptMetadata:
    ...
    def test_evaluate_dataset_with_prompt_version_option(self, cli_runner, tmp_path, monkeypatch):
    ...
    def test_evaluate_dataset_with_run_note_option(self, cli_runner, tmp_path, monkeypatch):
